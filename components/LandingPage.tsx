      ...
      <div className="fixed top-0 left-0 w-full h-screen overflow-hidden">
        ...
        <div style={{ opacity: pAscend > 0.1 ? 0 : 1, transition: 'opacity 0.5s' }}>
            <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                 <div style={{height: '12000px'}} className="absolute top-[-20%] left-1/2 -translate-x-1/2 w-[1200px] h-[1200px] bg-gradient-radial from-white via-white/10 to-transparent opacity-40 animate-pulse-slow" />
            </div>
        </div>
