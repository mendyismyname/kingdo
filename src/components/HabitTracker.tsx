      ...
      <div className="space-y-4">
            ...
            >
              <div className="flex items-center gap-5 relative z-10">
                ...
                <div className="flex-1">
                  <h3 className={`font-sans font-medium text-lg transition-colors duration-300 ${
                    isCompleted ? 'text-king-primary line-through opacity-60' : 'text-king-text'
                  }`}>
                    {habit.title}
                  </h3>
        ...
        <div className="mt-8 animate-slide-up" style={{ animationDelay: `${habits.length * 100}ms` }}>
          <form onSubmit={handleAdd} className="relative group bg-white rounded-2xl p-2 pl-6 shadow-sm border border-stone-100 flex items-center focus-within:ring-2 focus-within:ring-king-primary/20 focus-within:border-king-primary transition-all">
            ...
            <button 
              type="submit" 
              className="w-12 h-12 rounded-xl bg-stone-50 text-stone-300 hover:bg-king-primary hover:text-white transition-all font-bold text-2xl flex items-center justify-center ml-2"
            >
              +
            </button>
          </form>
