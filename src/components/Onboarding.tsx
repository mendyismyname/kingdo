...
import { Demographic, UserProfile, AppLanguage } from '../types';

interface OnboardingProps {
  onComplete: (profile: Omit<UserProfile, 'id' | 'totalStudyMinutes' | 'theme' | 'language'>) => void;
}
...
export const Onboarding: React.FC<OnboardingProps> = ({ onComplete }) => {
  ...
  const [community, setCommunity] = useState(''); // Changed from inviteCode to community
    ...
    if (step === 1 && name.trim()) {
       ...
       setTimeout(() => {
           onComplete({
            ...
            community: community.trim() === '' ? undefined : community.trim(), // Pass community
            ...
            <div className="min-h-[300px] flex flex-col justify-center">
                ...
                {step === 4 && (
                    <div className="animate-[fadeIn_0.5s_ease-out]">
                        ...
                        <p className="font-serif text-stone-400 italic mb-12">Enter community name (Optional)</p>
